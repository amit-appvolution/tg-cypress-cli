...
exports.isTurboScaleSession = (bsConfig) => {
  ...
  if (process.env.TESTGRID_TURBOSCALE && process.env.TESTGRID_TURBOSCALE === 'true') {
    return true;
  }
...
exports.getTurboScaleGridName = (bsConfig) => {
  // env var will override config
  if (process.env.TESTGRID_TURBOSCALE_GRID_NAME) {
    return process.env.TESTGRID_TURBOSCALE_GRID_NAME;
  }
