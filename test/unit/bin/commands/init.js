...
describe("init", () => {
  ...
  describe("get_path", () => {
    ...
    it("filename not passed, -path passed", () => {
      ...
      expect(get_path(args)).to.be.eql('/sample-path/testgrid.json');
    });
    ...
    it("filename not passed, -path  not passed", () => {
      ...
      expect(get_path(args)).to.be.eql(path.join(process.cwd(), 'testgrid.json'));
    });
  });
  ...
  describe("init", () => {
    ...
    it("fail if testgrid.json is already present", () => {
    ...
    it("create testgrid.json if not already present", () => {
      dirExistsStub = sandbox.stub().yields(true);
