  ...
  describe("redactKeys", () => {
    ...
    it("filters keys from cli_args", () => {
      const cli_args = {
        ...
        key: 'test_key',
        cf: 'testgrid.json',
        'config-file': 'testgrid.json',
        configFile: 'testgrid.json',
        '$0': 'testgrid-cypress'
      }
      ...
      expect(sanitizedCliArgs).to.be.equal("{\"_\":[\"generate-report\",\"ceb31f07eb386706ae7ab52ebe5d9b2ebf2fdebf\"],\"u\":[REDACTED],\"username\":[REDACTED],\"k\":[REDACTED],\"key\":[REDACTED],\"cf\":\"testgrid.json\",\"config-file\":\"testgrid.json\",\"configFile\":\"testgrid.json\",\"$0\":\"testgrid-cypress\"}");
      expect(redactKeys(JSON.stringify({
        ...
        configFile: 'testgrid.json',
        '$0': 'testgrid-cypress'
      }), CLI_ARGS_REGEX, REDACTED)).to.be.equal("{\"u\":[REDACTED],\"username\":[REDACTED],\"k\":[REDACTED],\"key\":[REDACTED],\"cf\":\"testgrid.json\",\"config-file\":\"testgrid.json\",\"configFile\":\"testgrid.json\",\"$0\":\"testgrid-cypress\"}");
      expect(redactKeys(JSON.stringify({
        u: 'test_123',
        username: 'test_123',
        k: 'test_key',
